<%-- 
    Document   : EditeExchange
    Created on : Apr 7, 2019, 11:20:14 PM
    Author     : AJAN
--%>
      ...
      <div class="container">
        <div class="row">
          <dbootiv class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> View Exchange Details </h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <div class="col-md-10 content">
            <!-- Website Overview -->
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Exchange Details</h3>
              </div>
              <div class="panel-body">
                  <div class="row">
                      ...
                      <div class="col-md-4 text-right">
                          <a href="Addexchange.jsp" class="btn btn-primary">Add Exchange</a>
                      </div>
                  </div>
                  ...
                  <table class="table table-bordered table-hover">
                      ...
                      <% 
                        try{
                              conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/example?autoReconnect=true&useSSL=false", "root", "ajan6");
                              st = conn.createStatement();
                              String query = request.getParameter("search");
                              String sql;
                              if(query != null){
                               sql ="SELECT * FROM example.exchangeitem where Name like '%"+query+"%'";
                              }
                              else {
                                sql ="SELECT * FROM example.exchangeitem";
                              }
                      ...
                      <
                      <td>
                          <a href='UpdateExchange.jsp?update=<%=rs.getString(11)%>' class='btn btn-warning btn-sm'>Update</a>
                          <a href='Delete?delete=<%=rs.getString(10)%>' class='btn btn-danger btn-sm'>Delete</a>
