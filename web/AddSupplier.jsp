                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Name" type ="text" id ="text-only" class="form-control" aria-label="..." required >
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="OpeningBalance" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                       ...
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Pnumber" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div> 
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Anumber" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="AccName" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="AccNumber" type ="number" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                    </div>
                    <br>
