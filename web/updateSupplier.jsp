      ...
      <div class="container-fluid">
        ...
        <div class="col-md-3 " id="sidebar">
          ...
          <div class="col-md-9 content">
			...
			String query = "select * from supplier where ID = '"+num+"'";
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Name" type ="text" id ="text-only" value="<%=rs.getString(1)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="OpeningBalance" type ="text" value="<%=rs.getString(2)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                       ...
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Pnumber" type ="text" value="<%=rs.getString(4)%>" class="form-control" aria-label="...">
                            </div>
                        </div> 
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Anumber" type ="text" value="<%=rs.getString(5)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name = "Email" type ="email" value="<%=rs.getString(6)%>" class="form-control" aria-label="..." >
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="AccName" type ="text" value="<%=rs.getString(9)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="AccNumber" type ="number" value="<%=rs.getString(10)%>" class="form-control" aria-label="...">
                                <input type = "hidden" name = "ID" value ='<%=rs.getInt(11)%>' >
                            </div>
                        </div>
                    </div>
                    <br>
