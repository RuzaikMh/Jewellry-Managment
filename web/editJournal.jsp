      ...
      <div class="container">
        <div class="row">
          <dbootiv class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Edit Journal Details </h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <!-- Website Overview -->
            <div class="col-md-10 content">
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Edit Journal Details</h3>
              </div>
              <div class="panel-body">
                  <div class="row">
                      ...
                      <div class="col-md-4 text-right">
                          <a href="addJournal.jsp" class="btn btn-primary">Insert Journal</a>
                      </div>
                  </div>
                ...
                <th>Action</th>
                      ...
                      <% 
                        try{
                              ...
                              String sql;
                              if(query != null){
                               sql ="SELECT * FROM jewellry.journal where jid like '%"+query+"%'";
                              }
                              else {
                ...
                <td><a href="updateJournal.jsp?jid=<%= rs.getInt("jid") %>" class='btn btn-warning btn-sm'>Edit</a>
                <a href="journalcontroller?jid=<%= rs.getInt("jid") %>&&for=delete" class='btn btn-danger btn-sm'>Delete</a></td>
            </tr>
