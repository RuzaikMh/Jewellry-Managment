<%-- 
    Document   : Homepage1
    Created on : Apr 4, 2019, 9:47:53 PM
    Author     : PATHMANATHAN
--%>
...
<li><a href="Login3.jsp"><span class="ico-account"></span>Sing in</a</li>

<li><a href="register2.jsp"><span class="ico-signout"></span>Sign up</a></li>
</ul>
</div>
</div>
