      ...
      <div class="container">
        <div class="row">
          <dbootiv class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Edit Product Details</h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <!-- Website Overview -->
            <div class="col-md-10 content">
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Edit Product Details</h3>
              </div>
              <div class="panel-body">
                  <div class="row">
                      ...
                      <div class="col-md-4 text-right">
                          <a href="AddProducts.jsp" class="btn btn-primary">Add Product</a>
                      </div>
                  </div>
                  ...
                  <table class="table table-bordered table-hover">
                      ...
                      <% 
                        try{
                              ...
                              String sql;
                              if(query != null){
                               sql ="SELECT * FROM jewellry.products where Pname like '%"+query+"%'";
                              }
                              else {
                                sql ="SELECT * FROM jewellry.products";
                              }
                     ...
                     <td><%=rs.getString(8) %></td>
                      ...
                      <td>
                          <div>
                          <a href='updateSupplier.jsp?update=<%=rs.getString(1)%>' class='btn btn-warning btn-xs'>Update</a>
                          </div>
                          <br>
                          <div>
                              <a href='deleteProduct?delete=<%=rs.getString(1)%>' class='btn btn-danger btn-xs'>Delete&nbsp;</a>
                          </div> 
                      </td>
                  </tr>
