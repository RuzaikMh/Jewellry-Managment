  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Add Journal</h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <div class="col-md-9">
            <!-- Website Overview -->
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Add Journal</h3>
              </div>
                ...
                <form action="journalcontroller" method="post"> 
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input  type="text" name="jid" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input type="date" name="date" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br>
                       ...
                       <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input type="text" name="debit" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class = "input-group">
                                ...
                                <input type="text" name="credit" class="form-control" aria-label="...">
                            </div>
                    ...
                    <div class="row">
                        <div class = "col-md-6" id = "save&rest">
                            <button  class="btn btn-primary btn-lg btn-block" name="insert"><span class="far fa-save" aria-hidden="true"></span> Save</button>  
                        </div>
                        <div class = "col-md-6" id = "save&rest">
