      ...
      <div class="container">
        <div class="row">
          <dbootiv class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Edit Supplier Details </h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <!-- Website Overview -->
            <div class="col-md-10 content">
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Edit Supplier Details</h3>
              </div>
                  ...
                  <table class="table table-bordered table-hover">
                      ...
                      <% 
                        try{
                              ...
                              String sql;
                              if(query != null){
                               sql ="SELECT * FROM jewellry.supplier where Name like '%"+query+"%'";
                              }
                              else {
                                sql ="SELECT * FROM jewellry.supplier";
                              }
                      ...
                      <td>
                          <div>
                          <a href='updateSupplier.jsp?update=<%=rs.getString(11)%>' class='btn btn-warning btn-xs'>Update</a>
                          </div>
                          <br>
                          <div>
                              <a href='Delete?delete=<%=rs.getString(11)%>' class='btn btn-danger btn-xs'>Delete&nbsp;</a>
                          </div>
                      </td>
                  </tr>
