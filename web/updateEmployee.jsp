<%-- 
    ...
    Created on : Apr 8, 2019, 5:09:01 PM
    Author     : Ruzaik Mh
--%>

<%-- 
    Document   : updateemployee
    Created on : Apr 7, 2019, 9:51:48 AM
    Author     : Ragulan
--%>

<%-- 
    Document   : updateSupplier
    Created on : Apr 6, 2019, 2:03:38 AM
    Author     : Ruzaik Mh
--%>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Employee ID" type ="text" id ="text-only" value="<%=rs.getString(1)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="First Name" type ="text" value="<%=rs.getString(2)%>" class="form-control" aria-label="...">
                            </div>
                       </div>
                    </div>
                            <br>
                     <div class="row">
                            ...
                            <div class = "input-group">
                                ...
                                <input name ="Last Name" type ="text" value="<%=rs.getString(3)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class = "input-group">
                 ...
                 <div class="row">
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Pnumber" type ="text" value="<%=rs.getString(5)%>" class="form-control" aria-label="...">
                            </div>
                        </div>                          
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Email" type ="text" value="<%=rs.getString(6)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                 </div>
                            <br>
                <div class="row">
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name = "Address" type ="text" value="<%=rs.getString(7)%>" class="form-control" aria-label="..." >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="City" type ="text" value="<%=rs.getString(8)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                        </div>
                </div>
            ...
            <div class="row">
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="date" type ="text" value="<%=rs.getString(9)%>" class="form-control" aria-label="...">
                            </div>
                        </div>  
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                <span class="input-group-addon">
                                    <lable>Job Status&nbsp;&nbsp;&nbsp;</lable>
                                </span>
                                <input name ="status" type ="text" value="<%=rs.getString(10)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
            </div>
            <br>
                      <div class="row">
                           <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="userName" type ="text" value="<%=rs.getString(11)%>" class="form-control" aria-label="...">
                            </div>
                        </div>              
                       <div class="col-md-6">
                            <div class = "input-group">
                                <span class="input-group-addon">
                                    <lable>Pass word&nbsp;&nbsp;</lable>
                                </span>
                                <input name ="password" type ="number" value="<%=rs.getString(12)%>" class="form-control" aria-label="...">
                                <input type = "hidden" name = "ID" value ='<%=rs.getInt(13)%>' >
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="panel-footer" id = "myfooter"><h2 id = "display" >${display}</h2></div>
    </div>
          </div>
        </div>
      </div>
