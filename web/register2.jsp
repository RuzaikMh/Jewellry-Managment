<%-- 
    Document   : register2
    Created on : Apr 8, 2019, 7:50:02 PM
    Author     : PATHMANATHAN
--%>
...
<li><a href="Login3.jsp"><span class="ico-account"></span>Sign in</a</li>
				...
				<form class="login100-form validate-form flex-sb flex-w" action="Register" method="post">
					<span class="login100-form-title p-b-51">
						...
						<span class="focus-input100"></span>
                                       ...
                                       <div class="wrap-input100 validate-input m-b-16" data-validate = "Lasttname is required">
						<input class="input100" type="text" name="lastname" placeholder="Lasttname">
						<span class="focus-input100"></span>
					</div>
						...
						<input class="input100" type="text" name="telNo" placeholder="Phone number">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
						...
						<span class="focus-input100"></span>
                                         ...
                                         <tr>
						<td></td>
						<td style="font-size: 20px; color: red;">${passwordErr}</td>
					</tr></br>
