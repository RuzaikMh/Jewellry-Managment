<%-- 
    Document   : Employee
    Created on : Apr 8, 2019, 4:48:50 PM
    Author     : Ruzaik Mh
--%>
<%-- 
    Document   : Employee
    Created on : Apr 4, 2019, 12:24:13 PM
    Author     : harry
--%>
      ...
      <div class="container">
        <div class="row">
          <dbootiv class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Add Employee </h1>
          </div>
        </div>
      </div>
    </header>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Employee ID" type ="text" id ="text-only" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="First Name" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                <span class="input-group-addon">
                                    ...
                                    <input name ="Last Name" type ="text" class="form-control" aria-label="...">
                    ...
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Pnumber" type ="number" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="status" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br>
                   <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="userName" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="password" type ="password" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
