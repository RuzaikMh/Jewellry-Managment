<%-- 
    Document   : Addexchange
    Created on : Apr 6, 2019, 5:30:20 PM
    Author     : AJAN
--%>
      ...
      <div class="container">
        <div class="row">
          <dbootiv class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Add Exchange </h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <div class="col-md-9 content">
            <!-- Website Overview -->
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Add Exchange Customer</h3>
              </div>
              <div class="panel-body">
                <form action = "AddExchange" method = "post"> 
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="ID" type ="text" id ="text-only" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="NicId" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="Mnumber" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div> 
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                <span class="input-group-addon">
                                    <lable>Home Phone</lable>
                                </span>
                                <input name ="Hnumber" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                    ...
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <span class="input-group-addon">
                                    <lable>Gold Karat&nbsp;&nbsp;&nbsp;</lable>
                                </span>
                                <select class="form-control" name ="karatType">
                                     <option value="" disabled selected>Choose Type</option>
                                     <option value="1">18karat</option>
                                     <option value="2">22karat</option>
                                     <option value="3">24karate</option>
                                     <option value="4">20karate</option>
                       ...
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="gram" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br> 
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                <span class="input-group-addon">
                                    <lable>Exchange Type&nbsp;&nbsp;&nbsp;</lable>
                                </span>
                                <select class="form-control" name ="ExchangeType">
                                     <option value="" disabled selected>Choose Type</option>
                                     <option value="1">Cash</option>
                                     <option value="2">Jewels</option>
                       ...
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="CusNumber" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
