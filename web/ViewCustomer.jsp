      ...
      <div class="container">
        <div class="row">
          <dbootiv class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>View Customers Details</h1>
          </div>
        </div>
      </div>
    </header>
                  ...
                  <table class="table table-bordered">
                      ...
                      <% 
                        try{
                              ...
                              String sql ="SELECT * FROM jewellry.login";
                      ...
                      <td>
			<td>
                          <a href='updateCustomer.jsp?update=<%=rs.getString(1)%>' class='btn btn-warning btn-sm'>Update</a>
                          <a href='deleteCustomer?delete=<%=rs.getString(1)%>' class='btn btn-danger btn-sm'>Delete</a>
