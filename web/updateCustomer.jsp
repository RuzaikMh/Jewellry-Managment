<%-- 
    ...
    Created on : Apr 6, 2019, 12:32:52 PM
    Author     : Ruzaik Mh
--%>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-9 content">
			...
			String query = "select * from login where uid= '"+num+"'";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="cId" type ="text" id ="text-only" value="<%=rs.getString(1)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="fname" type ="text" id ="text-only" value="<%=rs.getString(2)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                    ...
                    <div class="row">
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="lname" type ="text" value="<%=rs.getString(3)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="email" type ="email" value="<%=rs.getString(4)%>" class="form-control" aria-label="...">
                            </div>
                        </div> 
                    ...
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="City" type ="text" value="<%=rs.getString(5)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name = "telno" type ="text" value="<%=rs.getString(6)%>" class="form-control" aria-label="..." >
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="uname" type ="text" value="<%=rs.getString(7)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="password" type ="text" value="<%=rs.getString(8)%>" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
