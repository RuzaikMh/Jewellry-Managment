                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name="productid" type ="text" id ="text-only" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name="productname" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name="productprice" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                    ...
                    <br>
                         ...
                         <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name="qty" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                        <div class="col-md-6">
                        <label class="btn btn-primary" for="my-file-selector" id ="file">
                             <input name="picture" id="my-file-selector" type="file" style="display:none;">
                            Upload Picture
                        </label>
                        </div>
                    </div>
                    <br>
                     ...
                     <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name="weight"type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
