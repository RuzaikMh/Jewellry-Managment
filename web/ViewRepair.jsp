<%-- 
    Document   : ViewRepair
    Created on : Apr 8, 2019, 11:10:26 PM
    Author     : AJAN
--%>
              ...
              <div class="panel-body">
                  <div class="row">
                      ...
                      <div class="col-md-4 text-right">
                          <a href="ARepair.jsp" class="btn btn-primary">Add Repair</a>
                      </div>
                  </div>
                  ...
                  <table class="table table-bordered table-hover">
                      ...
                      <% 
                        try{
                              ...
                              String sql;
                              if(query != null){
                               sql ="SELECT * FROM  exchange.repair2 where Name like '%"+query+"%'";
                              }
                              else {
                                sql ="SELECT * FROM  exchange.repair2";
                              }
